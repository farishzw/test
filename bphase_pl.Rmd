...
test_length <- c(1000,2000,3000,5000)
true_phase1 <- c()
type_I_error1 <- c()
q1_0.05 <- c()
q1_0.95 <- c()
...
for (i in test_length){
    ...
    q1_0.05 <- append(q_0.05,quantile(colMeans(boot_phase),0.05))#计算分布的5%分位数
    q1_0.95 <- append(q_0.95,quantile(colMeans(boot_phase),0.95))#计算分布的95%分位数
